 ...
 * STRING MANIPULATION:
 * 
 * 0. Strings store and change text -- they are an important part of computer programming. As such, there are various tools 
 * available to manipulate the value of a string.
 * 1. There are a few operators that can help you re-assign strings: the assignment, concatenation, and a combination of the 
 * assignment and concatenation operators.  
 * 2.  There are several functions, or methods used on strings; some take in parameters and others don't.  Only a few methods 
 * are covered here: concat(), substring(), slice(), split(), join(), replace(), toUpperCase(), toLowerCase(), and trim().
 */
...
// 5. split() //
/* Divides a string into a set of substrings and deposits them into an array; depending on the the parameter provided, it 
   can split a string at characters or spaces 
*/
let text = "AC / DC"
...
// 6. join() //
/* Does the opposite of .split: it combines substrings into a single string; it can also manipulate the substrings through 

...
function greeter(hour) {
    ...
    //if the hour is between 0 & 11, print [text]
    if(hour >= 0 && hour <= 11){
        console.log("Good Morning!");
    //if the hour is between 12 & 16, print [text]
    }else if(hour >= 12 && hour <= 16){
        console.log("Good Afternoon!");
    //if the hour is between 17 & 21, print [text]
    }else if(hour >= 17 && hour <= 21){
        console.log("Good Evening!");
    //if the hour is between 22 & 24, print [text]
